...
namespace MagniFinanceExercise.Controllers
{
    public class ProfsController : Controller
    {
        ...
        public ProfsController(MagniFinanceExerciseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Birthdate,Salário")] Prof prof)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Birthdate,Salário")] Prof prof)
        {
            if (id != prof.Id)
            {
                return NotFound();
