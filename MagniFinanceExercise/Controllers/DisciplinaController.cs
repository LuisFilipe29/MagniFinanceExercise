...
namespace MagniFinanceExercise.Controllers
{
    public class DisciplinaController : Controller
    {
        ...
        public DisciplinaController(MagniFinanceExerciseContext context)
        {
            _context = context;
        }
        ...
        {
            var magniFinanceExerciseContext = _context.Disciplina.Include(d => d.curso);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,CursoId")] Disciplina disciplina)
        {
            ...
            ViewData["CursoId"] = new SelectList(_context.Curso, "Id", "Nome", disciplina.CursoId);
            return View(disciplina);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,CursoId")] Disciplina disciplina)
        {
            if (id != disciplina.Id)
            {
                return NotFound();
