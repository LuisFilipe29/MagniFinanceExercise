...
namespace MagniFinanceExercise.Controllers
{
    public class AlunoController : Controller
    {
        ...
        {
            var magniFinanceExerciseContext = _context.Aluno.Include(a => a.curso);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Birthdate,Num_Matricula,CursoId,Valor")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Birthdate,Num_Matricula,CursoId,Valor")] Aluno aluno)
        {
            if (id != aluno.Id)
            {
                return NotFound();
